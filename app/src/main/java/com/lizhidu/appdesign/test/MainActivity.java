...
import com.lizhidu.appdesign.BaseActivity;
import com.lizhidu.appdesign.R;
import com.lizhidu.appdesign.net.OkHttpUtils;
import com.lizhidu.appdesign.net.callback.BitmapCallback;
import com.lizhidu.appdesign.net.callback.FileCallBack;
import com.lizhidu.appdesign.net.callback.StringCallback;
import com.lizhidu.appdesign.utils.LogUtils;
import com.lizhidu.appdesign.utils.ToastUtils;
...
//                .params(params)//
    ...
    public void getInfo(View view){
        ...
        OkHttpUtils.get().addHeader("apikey","873a8e53180cf53e8687097cdad4b8a5").url(url).addParams("page","20").build().execute(new StringCallback() {
            @Override
            public void onError(Request request, Exception e) {
            ...
            @Override
            public void onResponse(String response) {
                ToastUtils.makeTextShort(getApplicationContext(),response);
